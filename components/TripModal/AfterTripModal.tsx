...
const AfterTripModal: React.FC<AfterTripModalProps> = ({
  visible,
  onClose,
  vehicleId,
  tripId,
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalTitle}>Tình trạng sau khi lên xe</Text>
